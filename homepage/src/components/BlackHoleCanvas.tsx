...
export const BlackHoleCanvas: React.FC<BlackHoleCanvasProps> = ({
  ...
  const fragmentShaderSource = `
    ...
    vec3 getDiskColor(float dist, float g, float n) {
      ...
      // Color mapping: hotter light is white, medium is pure orange (#FF5C00), cooler is deep orange-red, redshifted is dark red-orange
    ...
    void main() {
      ...
      if (!hitEventHorizon && accumAlpha < 1.0) {
        ...
        vec3 dustColor = mix(
          vec3(0.01, 0.0, 0.025), // deep purple
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      // FPS tracking for performance self-tuning
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      particles.push({
        ...
        color: radius < 110 ? "rgba(255, 95, 20, " : "rgba(217, 27, 92, ",
    ...
    const drawFallback = () => {
      ...
      nebulaGlow.addColorStop(0, "rgba(255, 92, 0, 0.1)");
      nebulaGlow.addColorStop(0.3, "rgba(255, 115, 0, 0.06)");
      nebulaGlow.addColorStop(0.6, "rgba(255, 50, 0, 0.02)");
      ...
      ctx.lineWidth = 4;
      ctx.strokeStyle = "rgba(255, 92, 0, 0.12)";
      ctx.beginPath();
      ...
      innerGlow.addColorStop(0.2, "rgba(255, 92, 0, 0.9)");
      innerGlow.addColorStop(0.7, "rgba(255, 50, 0, 0.3)");
      ...
      gradientDisk.addColorStop(0.4, "rgba(255, 92, 0, 0.8)");
      gradientDisk.addColorStop(0.7, "rgba(255, 115, 0, 0.4)");
    ...
    >
      ...
      <div 
        ...
        style={{
          ...
          background: `radial-gradient(circle, rgba(255,92,0,0.15) 0%, rgba(139,92,246,0.12) 40%, rgba(99,102,241,0.04) 75%, rgba(0,0,0,0) 100%)`,
        }}
      />
