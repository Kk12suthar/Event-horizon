      ...
      <div className="flex items-center gap-12">
        ...
        >
          <div className="relative w-6 h-6 flex items-center justify-center">
            ...
            <span className="absolute inset-0 border border-white/20 rounded-full group-hover:border-plasma-orange/50 group-hover:scale-110 transition-all duration-500 animate-spin-slow" />
        ...
        <nav className="hidden md:flex items-center gap-8 font-display text-[11px] font-medium tracking-widest uppercase opacity-80" id="nav-menu">
          {[
            { label: "The Pull", id: "section-pull" },
            { label: "Transformation", id: "section-transform" },
