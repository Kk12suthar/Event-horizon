    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center max-w-4xl mt-12 md:mt-0">
        ...
        <motion.p
          ...
          id="hero-description"
        >
          EventHorizon is an AI data workspace. Bring raw datasets into a project,
          let the agent prepare and transform them, then visualize dashboards and
          publish reports &mdash; every stage in one gravity well.
        </motion.p>
