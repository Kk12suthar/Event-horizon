...
import { ChevronsLeftRight, Database, RefreshCw } from "lucide-react";
        ...
        <div className="text-center max-w-2xl space-y-4">
          <h2 className="font-display font-semibold text-3xl md:text-5xl text-white tracking-tight uppercase">
            ...
            <span className="block text-zinc-500 font-light text-xl md:text-2xl mt-2 lowercase font-sans">
              raw data into clean, structured tables
            </span>
          </h2>

          <p className="text-zinc-400 text-sm font-sans leading-relaxed font-light">
            In Prepare mode you simply chat with the AI agent. It cleans, joins, and
            reshapes your raw data into structured, agent-created tables you can trust
            &mdash; and every tool call and transformation is streamed live as the agent
            works. Drag the slider to see raw chaos resolve into a clean result.
          </p>
        </div>
        ...
        >
          ...
          <div className="absolute inset-0 w-full h-full bg-void flex flex-col p-6 pr-12 md:p-10">
            <div className="flex items-center gap-2 mb-6">
              <RefreshCw className="w-4 h-4 text-plasma-purple animate-spin-slower" />
                  ...
                  <svg className="w-full h-full" viewBox="0 0 300 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                      <linearGradient id="gradient-wave-orange" x1="0" y1="0" x2="300" y2="0" gradientUnits="userSpaceOnUse">
                        <stop offset="0%" stopColor="#c16e43" />
                        <stop offset="50%" stopColor="#c16e43" />
                        <stop offset="100%" stopColor="#d08a5e" />
                      </linearGradient>
                    </defs>
                  </svg>
